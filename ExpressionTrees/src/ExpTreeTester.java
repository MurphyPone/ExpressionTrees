...
public class ExpTreeTester {
	public static void main(String[] args) {
		...
		String[] exp5 = new String[] { "1", "0", "/" }; //= infinity
		...
		ExpressionTree div0 = new ExpressionTree(exp5);
		...
		System.out.println("The value of div0 is: " + div0.evalTree() );
		...
		System.out.println("stk in prefix notation is: " + div0.toPrefixNotation() + " = " + div0.evalTree() );
		...
		System.out.println("div0 in infix notation is: " + div0.toInfixNotation() + " = " + div0.evalTree() );
		...
		System.out.println("div0 in postfix notation is: " + div0.toPostfixNotation() + " = " + div0.evalTree() );
	}
}